 ...
 */
public class EncryptedField extends Field {
    ...
    public EncryptedField(String key, String label, String placeholder,
            String tooltip) {
        super(key, label, placeholder, tooltip);
    }

    public EncryptedField(String key, String label, String placeholder,
            String tooltip, Validator validator) {
        super(key, label, placeholder, tooltip, validator);
    }

    public void setValue(String value) {
        super.setValue(encrypt(value.getBytes()));
    }
    ...
    public String decryptValue() {
        ...
        try {
            ...
            return new String(
                    cipher.doFinal(Base64.getDecoder().decode(getValue())));
        } catch (InvalidKeyException | BadPaddingException
                | IllegalBlockSizeException e) {
